...
<?php if (isset($fields['still_url']) && !empty($fields['still_url']->content)): ?>
  ...
  <?php else: ?>
<?php print l(theme('image', array('path' => drupal_get_path('theme', 'sitebuilder_uva') . '/images/notgranted-thumb.png', 'width' => '220px', 'height' => '124px', 'alt' => t("You don't have the right permissions to access this video"))), 'asset/detail/' . $fields['asset_id']->raw, array('html' => TRUE, 'attributes' => array('class' => 'views-field-still-url'))); ?>
  <?php endif; ?>
<?php endif; ?>
...
<div class="asset-information">
  ...
  <?php print $fields['owner_id']->wrapper_prefix; ?>
  <?php print $fields['owner_id']->content; ?>
  <?php print $fields['owner_id']->wrapper_suffix; ?>
