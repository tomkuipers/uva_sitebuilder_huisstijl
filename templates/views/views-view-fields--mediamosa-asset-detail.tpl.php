...
<div class="asset-technical-information">
  ...
  <h2>
    <?php print l('Metadata (Dublin Core)', 'asset/detail/' . $fields['asset_id']->raw, array('fragment' => 'metadata-dc', 'attributes' => array('name' => 'metadata-dc'))); ?>
  </h2>
  ...
  <h2>
    <?php print l('Metadata (Qualified Dublin Core)', 'asset/detail/' . $fields['asset_id']->raw, array('fragment' => 'metadata-qdc', 'attributes' => array('name' => 'metadata-qdc'))); ?>
  </h2>
