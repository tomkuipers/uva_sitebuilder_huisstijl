...
<?php if (isset($fields['still_url']) && !empty($fields['still_url']->content)): ?>
  ...
  <?php else: ?>
<?php print l(theme('image', array('path' => drupal_get_path('theme', 'sitebuilder_uva') . '/images/notgranted-thumb.png', 'height' => '170px', 'width' => '300px' ,'alt' => t("You don't have the right permissions to access this video"))), 'asset/detail/' . $fields['asset_id']->raw, array('html' => TRUE, 'attributes' => array('class' => 'views-field-still-url'))); ?>
  <?php endif; ?>
<?php endif; ?>
